...
pub enum Operator<'a> {
    ...
    S32Load8U { memarg: MemoryImmediate },
    S32Load16S { memarg: MemoryImmediate },
    S32Load16U { memarg: MemoryImmediate },
    S64Load8S { memarg: MemoryImmediate },
    S64Load8U { memarg: MemoryImmediate },
    S64Load16S { memarg: MemoryImmediate },
    S64Load16U { memarg: MemoryImmediate },
    S64Load32S { memarg: MemoryImmediate },
    S64Load32U { memarg: MemoryImmediate },
    S32Store { memarg: MemoryImmediate },
    S64Store { memarg: MemoryImmediate },
    S32Store8 { memarg: MemoryImmediate },
    S32Store16 { memarg: MemoryImmediate },
    S64Store8 { memarg: MemoryImmediate },
    S64Store16 { memarg: MemoryImmediate },
    S64Store32 { memarg: MemoryImmediate },
    S32Const { value: i32 },
    S64Const { value: i64 },
