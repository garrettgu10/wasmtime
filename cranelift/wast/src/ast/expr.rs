...
instructions! {
    pub enum Instruction<'a> {
        ...
        // ct-wasm
        S32Load(MemArg<4>) : [0xfb, 0x28] : "s32.load",
        S64Load(MemArg<8>) : [0xfb, 0x29] : "s64.load",
        // skipping f32 and f64
        S32Load8s(MemArg<1>) : [0xfb, 0x2c] : "s32.load8_s",
        S32Load8u(MemArg<1>) : [0xfb, 0x2d] : "s32.load8_u",
        S32Load16s(MemArg<2>) : [0xfb, 0x2e] : "s32.load16_s",
        S32Load16u(MemArg<2>) : [0xfb, 0x2f] : "s32.load16_u",
        S64Load8s(MemArg<1>) : [0xfb, 0x30] : "s64.load8_s",
        S64Load8u(MemArg<1>) : [0xfb, 0x31] : "s64.load8_u",
        S64Load16s(MemArg<2>) : [0xfb, 0x32] : "s64.load16_s",
        S64Load16u(MemArg<2>) : [0xfb, 0x33] : "s64.load16_u",
        S64Load32s(MemArg<4>) : [0xfb, 0x34] : "s64.load32_s",
        S64Load32u(MemArg<4>) : [0xfb, 0x35] : "s64.load32_u",
        S32Store(MemArg<4>) : [0xfb, 0x36] : "s32.store",
        S64Store(MemArg<8>) : [0xfb, 0x37] : "s64.store",
        // skipping f32 and f64
        S32Store8(MemArg<1>) : [0xfb, 0x3a] : "s32.store8",
        S32Store16(MemArg<2>) : [0xfb, 0x3b] : "s32.store16",
        S64Store8(MemArg<1>) : [0xfb, 0x3c] : "s64.store8",
        S64Store16(MemArg<2>) : [0xfb, 0x3d] : "s64.store16",
        S64Store32(MemArg<4>) : [0xfb, 0x3e] : "s64.store32",
        ...
        // ct-wasm 
        S32Clz : [0xfb, 0x67] : "s32.clz",
        S32Ctz : [0xfb, 0x68] : "s32.ctz",
        S32Popcnt : [0xfb, 0x69] : "s32.popcnt",
        S32Add : [0xfb, 0x6a] : "s32.add",
        S32Sub : [0xfb, 0x6b] : "s32.sub",
        S32Mul : [0xfb, 0x6c] : "s32.mul",
        S32DivS : [0xfb, 0x6d] : "s32.div_s",
        S32DivU : [0xfb, 0x6e] : "s32.div_u",
        S32RemS : [0xfb, 0x6f] : "s32.rem_s",
        S32RemU : [0xfb, 0x70] : "s32.rem_u",
        S32And : [0xfb, 0x71] : "s32.and",
        S32Or : [0xfb, 0x72] : "s32.or",
        S32Xor : [0xfb, 0x73] : "s32.xor",
        S32Shl : [0xfb, 0x74] : "s32.shl",
        S32ShrS : [0xfb, 0x75] : "s32.shr_s",
        S32ShrU : [0xfb, 0x76] : "s32.shr_u",
        S32Rotl : [0xfb, 0x77] : "s32.rotl",
        S32Rotr : [0xfb, 0x78] : "s32.rotr",

        S64Clz : [0xfb, 0x79] : "s64.clz",
        S64Ctz : [0xfb, 0x7a] : "s64.ctz",
        S64Popcnt : [0xfb, 0x7b] : "s64.popcnt",
        S64Add : [0xfb, 0x7c] : "s64.add",
        S64Sub : [0xfb, 0x7d] : "s64.sub",
        S64Mul : [0xfb, 0x7e] : "s64.mul",
        S64DivS : [0xfb, 0x7f] : "s64.div_s",
        S64DivU : [0xfb, 0x80] : "s64.div_u",
        S64RemS : [0xfb, 0x81] : "s64.rem_s",
        S64RemU : [0xfb, 0x82] : "s64.rem_u",
        S64And : [0xfb, 0x83] : "s64.and",
        S64Or : [0xfb, 0x84] : "s64.or",
        S64Xor : [0xfb, 0x85] : "s64.xor",
        S64Shl : [0xfb, 0x86] : "s64.shl",
        S64ShrS : [0xfb, 0x87] : "s64.shr_s",
        S64ShrU : [0xfb, 0x88] : "s64.shr_u",
        S64Rotl : [0xfb, 0x89] : "s64.rotl",
        S64Rotr : [0xfb, 0x8a] : "s64.rotr",
        ...
        // ct-wasm 
        S32Eqz : [0xfb, 0x45] : "s32.eqz",
        S32Eq : [0xfb, 0x46] : "s32.eq",
        S32Ne : [0xfb, 0x47] : "s32.ne",
        S32LtS : [0xfb, 0x48] : "s32.lt_s",
        S32LtU : [0xfb, 0x49] : "s32.lt_u",
        S32GtS : [0xfb, 0x4a] : "s32.gt_s",
        S32GtU : [0xfb, 0x4b] : "s32.gt_u",
        S32LeS : [0xfb, 0x4c] : "s32.le_s",
        S32LeU : [0xfb, 0x4d] : "s32.le_u",
        S32GeS : [0xfb, 0x4e] : "s32.ge_s",
        S32GeU : [0xfb, 0x4f] : "s32.ge_u",
        
        S64Eqz : [0xfb, 0x50] : "s64.eqz",
        S64Eq : [0xfb, 0x51] : "s64.eq",
        S64Ne : [0xfb, 0x52] : "s64.ne",
        S64LtS : [0xfb, 0x53] : "s64.lt_s",
        S64LtU : [0xfb, 0x54] : "s64.lt_u",
        S64GtS : [0xfb, 0x55] : "s64.gt_s",
        S64GtU : [0xfb, 0x56] : "s64.gt_u",
        S64LeS : [0xfb, 0x57] : "s64.le_s",
        S64LeU : [0xfb, 0x58] : "s64.le_u",
        S64GeS : [0xfb, 0x59] : "s64.ge_s",
        S64GeU : [0xfb, 0x5a] : "s64.ge_u",
        ...
        // ct-wasm
        S32WrapS64 : [0xfb, 0xa7] : "s32.wrap_s64" | "s32.wrap/s64",
        S64ExtendS32S : [0xfb, 0xac] : "s64.extend_s32_s" | "s64.extend_s/s32",
        S64ExtendS32U : [0xfb, 0xad] : "s64.extend_s32_u" | "s64.extend_u/s32",
        S32Classify : [0xfb, 0xc0] : "s32.classify",
        S64Classify : [0xfb, 0xc1] : "s64.classify",
        I32Declassify : [0xfb, 0xc2] : "i32.declassify",
        I64Declassify : [0xfb, 0xc3] : "i64.declassify",
